...
export const SwitchHorizontalIcon: IconComponent = (props) => (
  <BaseIcon
    viewBox="0 0 24 24"
    strokeWidth="2"
    {...props}
...
export const CoffeeCupIcon: IconComponent = (props) => (
  <BaseIcon
    viewBox="0 0 24 24"
    strokeLinecap="round"
    strokeLinejoin="round"
...
export const CoffeeBeanIcon: IconComponent = (props) => (
  <BaseIcon
    viewBox="0 0 24 24"
    {...props}
  >
...
export const ArrowPathIcon: IconComponent = (props) => (
  <BaseIcon
    viewBox="0 0 24 24"
    strokeWidth="1.5"
    {...props}
