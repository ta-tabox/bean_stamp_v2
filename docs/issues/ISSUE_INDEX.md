...
このディレクトリのファイルは、そのまま GitHub Issue の本文に貼り付けることを想定しています。

実行順:

1. `ISSUE_00.md` 新リポジトリ初期化
2. `ISSUE_01.md` 移行資材取り込み
3. `ISSUE_02.md` アーキテクチャ骨組み
4. `ISSUE_03.md` DB実装（PostgreSQL + Prisma）
5. `ISSUE_04.md` 認証基盤
